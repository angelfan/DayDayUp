...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnFeatureHtmlTable ( oSettings )
		{
            ...
            // add the last callback as the user given callback
            if ( typeof oInit.fnLastDrawCallback == 'function' )
            {
                /* Add user given callback function to array */
                oSettings.aoDrawCallback.push( {
                    "fn": oInit.fnLastDrawCallback,
                    "sName": "user"
                } );
            }
		...
		function _fnAjustColumnSizing ( oSettings )
		{
			...
			var oHeaders = $('th', oSettings.nTable);
			...
			for ( var i=0 , iLen=oSettings.aoColumns.length ; i<iLen ; i++ )
			{
				...
				oHeaders[i-invisible_count].style.width = oSettings.aoColumns[i].sWidth;
			}
		}
...
/*				if ( oSettings.fnDisplayEnd() == oSettings.fnRecordsDisplay() || oSettings.fnRecordsDisplay() <= oSettings._iDisplayLength)
				{
...
*/				
		...
		function _fnCalculateColumnWidths ( oSettings )
		{
			...
			else
			{
				...
				oSettings.nTHead.parentNode.style.width = _fnStringToCss( $(nCalcTmp).outerWidth() ); 
